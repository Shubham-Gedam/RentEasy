...
const Cart = () => {
  const { cart, removeFromCart } = useCartStore(); // confirmBooking yahan se hata diya
  ...
  const handleCheckout = () => {
    // Ab user seedha checkout page pe jayega details bharne
    navigate('/checkout');
  };
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-3xl font-black text-gray-900 mb-2 tracking-tighter italic text-left">Bag is empty.</h2>
  ...
  return (
    <div className="bg-[#fcfcfd] min-h-screen text-left">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-black text-gray-900 tracking-tighter mb-12 italic uppercase text-left">Review Bag<span className="text-blue-600">.</span></h1>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border border-gray-100 rounded-[40px] p-8 sticky top-24 shadow-sm">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between font-black text-gray-900 text-2xl border-t border-dashed pt-4"><span>Total Cost</span><span>₹{subtotal + totalDeposit}</span></div>
              </div>
